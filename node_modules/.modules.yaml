...
hoistedDependencies:
  ...
  /@babel/plugin-syntax-bigint/7.8.3(@babel/core@7.24.1):
  ...
  /babel-preset-current-node-syntax/1.0.1(@babel/core@7.24.1):
    babel-preset-current-node-syntax: private
  /babel-preset-jest/29.6.3(@babel/core@7.24.1):
...
pendingBuilds: []
prunedAt: Fri, 15 Mar 2024 13:15:34 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
